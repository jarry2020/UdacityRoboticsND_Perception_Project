...
[img_gazebo]:./images/img_gazebo.png
[img_test1]:./images/img_test1.png
[img_test2]:./images/img_test2.png
[img_test3]:./images/img_test3.png
...
Here is a image of Gazebo workspace:
![img_gazebo]
...
2. Use the  "Statistical Outlier Filter" and "VoxelGrid Downsampling Filter" to get ride of the outliers and downsampling the point cloud data.
```python
...
```
3. Use "Pass Through Filter" to crop the given 3D point cloud into different regions of interest.
```python
# PassThrough Filter
...
cloud_passthrough = passthrough.filter()
```
4. Use RANSAC Plane Segmentation to identify points in your dataset that belong to a particular model.
```python
...
```
Here is the results of extracted 'table' and 'objects', respectively:
![img_table]
![img_object]
...
```
I tried different "Cluster Tolerance", "Min Cluster Size", and "Max Cluster Size". First, I chose small "Cluster Tolerance" and "Max Cluster Size", e.g., 0.001 and 1000, respectively. The algorithm failed to create different segentations. After several trys, I found appropriate values for these parameters. The clustering result is:
![img_cluster]

#### 3. Complete Exercise 3 Steps.  Features extracted and SVM trained.  Object recognition implemented.
Follow the "[Object Recognition](https://classroom.udacity.com/nanodegrees/nd209/parts/586e8e81-fc68-4f71-9cab-98ccd4766cfe/modules/e5bfcfbd-3f7d-43fe-8248-0c65d910345a/lessons/81e87a26-bd41-4d30-bc8b-e747312102c6/concepts/8389976c-550a-4fde-a530-65ca24b31f05)" Steps to implement object recognition to the filtered 'objects' point cloud data.
```python
